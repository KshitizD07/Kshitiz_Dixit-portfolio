  ...
  return (
    <section className={`section section-left ${isActive ? 'section-active' : ''}`}>
      ...
      <div className="content-card">
        ...
        <p style={{ fontStyle: 'italic', marginBottom: '1.5rem', color: 'var(--color-text-muted)' }}>
        ...
        <p style={{ marginTop: '1rem', borderTop: '1px solid rgba(212, 163, 115, 0.2)', paddingTop: '1rem' }}>
